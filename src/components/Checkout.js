...
const Checkout = () => {
    ...
    return (
        <div className='mt-12'>
           <section>
  <h1 class="text-center text-4xl mb-10">Checkout</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
      <div class="bg-gray-50 py-12 md:py-24">
        <div class="mx-auto max-w-lg px-4 lg:px-8">
          ...
          <div class="mt-8">
            <p class="text-2xl font-medium tracking-tight">${courses.price}</p>
              ...
              <ul class="-my-4 divide-y divide-gray-200">
                <li class="flex items-center justify-between py-4">
                  <div class="flex items-start">
                    ...
                    <div class="ml-4">
                      <p class="text-sm">{courses.title}</p>

                      <dl class="mt-1 space-y-1 text-xs text-gray-500">
                        <div>
                          <dt class="inline">instructor: </dt>
                          <dd class="inline">{courses.instructor}</dd>
                        </div>

                        <div>
                          <dt class="inline">Level: </dt>
                          <dd class="inline">{courses.lavel}</dd>
                        </div>
                      </dl>
                    </div>
                  </div>
